...
<div className="lg:p-32 p-10">
  ...
  <div className="flex flex-col items-center justify-center lg:mt-32 mt-20">
  <div className="lg:flex justify-center">
    <div className="flex flex-col justify-center lg:mr-32 lg:mb-0 mb-14 items-center w-[270px]">
    ...
    <div className="flex flex-col justify-center lg:mr-32 lg:mb-0 mb-14 items-center w-[270px]">
      <div className="p-3 rounded-full border-4 border-[#062925] w-[130px]">
        <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 24 24" fill="none" stroke="#062925" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-list-checks">
    ...
    <div className="flex flex-col justify-center  items-center w-[270px]">
      <div className="p-3 rounded-full border-4 border-[#062925] w-[130px]">
        <svg xmlns="http://www.w3.org/2000/svg" width="100" height="100" viewBox="0 0 24 24" fill="none" stroke="#062925" stroke-width="1" stroke-linecap="round" stroke-linejoin="round" class="lucide lucide-hammer">
